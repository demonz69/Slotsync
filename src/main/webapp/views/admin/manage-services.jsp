...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="${pageContext.request.contextPath}/services?action=list" class="active">Services</a>
            <a href="${pageContext.request.contextPath}/admin?action=reports">Reports</a>
        </nav>
                        ...
                        <c:otherwise>
                            <c:forEach var="s" items="${services}" varStatus="st">
                                <tr>
                                    ...
                                    <td class="right bold">&pound;<fmt:formatNumber value="${s.price}" pattern="#,##0.00"/></td>
