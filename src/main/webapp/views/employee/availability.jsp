...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ΓöÇΓöÇ Sidebar (same as profile.jsp) ΓöÇΓöÇ */
        .emp-sidebar {
        ...
        /* ΓöÇΓöÇ Availability table ΓöÇΓöÇ */
        .avail-table-wrap {
...
<main class="emp-main" id="emp-main">
    ...
    <% if (success != null) { %>
        <div class="av-alert av-alert-success">Γ£ö <%= success %></div>
    <% } %>
    <% if (error != null) { %>
        <div class="av-alert av-alert-error">Γ£û <%= error %></div>
    <% } %>
