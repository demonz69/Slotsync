...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── Top row: profile form + password form ── */
        .profile-top-row {
            display: grid;
...
<main class="emp-main" id="emp-main">
    ...
    <div class="profile-top-row">
        ...
        <div class="profile-card" id="profile-info-card">
            ...
            <% if (success != null) { %>
                <div class="pf-alert pf-alert-success" id="profile-success-msg">✔ <%= success %></div>
            <% } %>
            <% if (error != null) { %>
                <div class="pf-alert pf-alert-error" id="profile-error-msg">✖ <%= error %></div>
            <% } %>
        ...
        <div class="profile-card" id="profile-pw-card">
            ...
            <% if (pwSuccess != null) { %>
                <div class="pf-alert pf-alert-success" id="pw-success-msg">✔ <%= pwSuccess %></div>
            <% } %>
            <% if (pwError != null) { %>
                <div class="pf-alert pf-alert-error" id="pw-error-msg">✖ <%= pwError %></div>
            <% } %>
