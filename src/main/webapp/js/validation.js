/**
 * SlotSync ΓÇö Client-side Form Validation
 ...
 *
 * Covers:
 *  ΓÇó Login form          (#login-form)
 *  ΓÇó Register form       (#register-form)
 *  ΓÇó Contact form        (#contact-form)
 *  ΓÇó Profile info form   (#profile-info-form)
 *  ΓÇó Change password     (#profile-pw-form)
 *  ΓÇó Availability form   (#avail-form)
 *  ΓÇó Booking form        (#booking-form)
 */
...
const Rules = {
    ...
    /** ^[A-Za-z ]+$  ΓÇö only letters and spaces (same regex as Java) */
    validName(value) {
        return /^[A-Za-z ]+$/.test(value.trim());
    },

    /** ^[A-Za-z0-9+_.-]+@(.+)$  ΓÇö same regex as Java */
    validEmail(value) {
    ...
    /** Valid phone ΓÇö digits, spaces, +, -, () allowed, min 7 digits */
    validPhone(value) {
        const digits = value.replace(/\D/g, '');
        return digits.length >= 7 && /^[+\d\s\-().]+$/.test(value.trim());
    },

    /** Time string HH:MM ΓÇö end must be after start */
...
/**
 * Mark a field as invalid ΓÇö adds red border + shows error message.
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   FORM ΓåÆ VALIDATOR MAP  &  AUTO-ATTACH
ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
